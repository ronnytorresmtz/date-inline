...
Nova.booting(function (Vue, router, store) {
  Vue.component('index-date-inline', __webpack_require__(4));
  Vue.component('detail-date-inline', __webpack_require__(16));
  Vue.component('form-date-inline', __webpack_require__(19));
});
...
var update = __webpack_require__(7)("026ce05d", content, false, {});
...
// module
exports.push([module.i, "\n.\\!cursor-not-allowed[data-v-9e63f81a] {\n  cursor: not-allowed !important;\n}\n", ""]);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_flatpickr_dist_themes_airbnb_css__ = __webpack_require__(11);
        ...
        dateChange: function dateChange(e) {
            ...
            if (this.isValidDate) {
                ...
                Object.keys(fields).forEach(function (key) {
                    if (fields[key].attribute !== _this2.field.attribute) {
                ...
                return Nova.request().post('/nova-api/' + this.resourceName + '/' + this.resourceId, formData).then(function () {
                    _this2.$toasted.show(_this2.field.name + ' updated to "' + value + '"', { type: 'success' });
                }, function (response) {
                    _this2.$toasted.show(response, { type: 'error' });
                });
            } else {
                this.$toasted.show(e.target.name + ' ' + e.target.value + ' is not valid (\'YYYY-MM-DD\')', { type: 'error' });
            }
        },
        checkValidDate: function checkValidDate(date) {
            if (date.length === 0) {
                return true;
            }
            if (date.length !== 10) {
    ...
    "div",
    {
      ...
      on: {
        keyup: function($event) {
          ...
          return _vm.closeDatePicker($event)
        }
      }
    },
    [
          ...
          directives: [
            {
              name: "show",
              rawName: "v-show",
              value: !_vm.isValidDate,
              expression: "!isValidDate"
            }
          ],
      ...
      _c("input", {
        ...
        attrs: {
          ...
          name: _vm.field.name,
          id: _vm.field.namd + _vm.field.value + _vm.field.id,
